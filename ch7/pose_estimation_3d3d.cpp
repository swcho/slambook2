...
int main(int argc, char **argv) {
  ...
  // 3D 점 생성
  Mat depth1 = imread(argv[3], CV_LOAD_IMAGE_UNCHANGED);       // 깊이 맵은 16비트 부호 없는 정수, 단채널 이미지
  Mat depth2 = imread(argv[4], CV_LOAD_IMAGE_UNCHANGED);       // 깊이 맵은 16비트 부호 없는 정수, 단채널 이미지
